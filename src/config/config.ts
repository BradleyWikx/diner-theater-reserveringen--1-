...
export const i18n = {
    ...
    errors: {
        fillAllFields: 'Vul alle verplichte velden in om verder te gaan',
        invalidEmail: 'Voer een geldig e-mailadres in (bijvoorbeeld: naam@voorbeeld.nl)',
        invalidPhone: 'Voer een geldig telefoonnummer in',
        selectShow: 'Selecteer eerst een voorstelling',
        minimumGuests: 'Er moet minimaal 1 gast zijn voor een reservering',
        maximumGuests: 'Het maximum aantal gasten voor deze voorstelling is bereikt',
        noAvailableShows: 'Er zijn geen beschikbare voorstellingen voor de geselecteerde datum',
        bookingFailed: 'Reservering kon niet worden voltooid. Probeer het opnieuw of neem contact met ons op.',
        networkError: 'Netwerkverbinding verbroken. Controleer uw internetverbinding en probeer opnieuw.',
        soldOut: 'Deze voorstelling is helaas uitverkocht',
        bookingDeadline: 'De reserveringstermijn voor deze voorstelling is verstreken',
        invalidPromoCode: 'Deze promocode is niet geldig of verlopen',
        expiredPromoCode: 'Deze promocode is helaas verlopen',
        usedPromoCode: 'Deze promocode is al gebruikt en kan niet opnieuw worden toegepast'
    },
    ...
    awaitingApproval: '⏳ Reservering Ontvangen',
    provisionalBookingConfirm: 'Uw reservering is succesvol ontvangen en wordt zo spoedig mogelijk door ons bevestigd. U ontvangt binnen 24 uur een definitieve bevestiging per e-mail.',
    close: 'Sluiten',
    wizardStep1Title: 'Stap 1: Kies uw arrangement',
    wizardStep1SubTitle: 'Selecteer het gewenste diner-theater arrangement en aantal gasten',
    standardPackage: 'Standaard Arrangement',
    packageStandard: 'Voorstelling + dinerbuffet + standaard drankenpakket',
    premiumPackage: 'Premium Arrangement', 
    packagePremium: 'Voorstelling + dinerbuffet + premium drankenpakket (inclusief sterke drank en bubbels)',
    provisionalBookingWarning: '⚠️ Deze reservering wordt voorlopig vastgelegd',
    wizardStep2Title: 'Stap 2: Extra drankjes',
    wizardStep2SubTitle: 'Selecteer optionele borrels voor groepen van 25+ personen',
    addonMin25: 'Alleen beschikbaar vanaf 25 gasten',
    wizardStep4Title: 'Stap 4: Uw contactgegevens',
    celebrationName: 'Naam van de jarige/gevierde (optioneel)',
    celebrationOccasion: 'Reden van viering (optioneel)',
    formConsent: 'Privacy en voorwaarden',
    consentNewsletter: 'Ja, ik wil graag de nieuwsbrief ontvangen met updates en aanbiedingen',
    consentTerms: 'Ik ga akkoord met de algemene voorwaarden en het privacybeleid *',
    wizardStep5Title: 'Stap 5: Controleer uw reservering',
    yourSelection: 'Uw gekozen arrangement',
    edit: 'Wijzigen',
    pricing: 'Prijs per persoon',
    ...
    selectDatePromptBooking: 'Selecteer een datum om te reserveren',
    noShowOnDate: 'Geen voorstelling op deze datum',
    startCheckIn: 'Inchecken starten',
    generating: 'Genereren',
    generateSummary: 'Samenvatting genereren',
    bookingSummary: 'Reserveringsoverzicht',
    promoCodeLabel: 'Promocode of Theaterbon',
    applyCode: 'Toepassen',
    subtotal: 'Subtotaal',
    discount: 'Korting',
    instructions: 'Klik op een datum om een reservering te maken',
    collapse: 'Inklappen',
    expand: 'Uitklappen',
    summaryOfYourBookingMobile: 'Overzicht van uw boeking',
